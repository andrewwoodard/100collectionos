 ...
 * Used by the admin approval flow (AdminReview.jsx) and mirrors the logic
 * in the reconcilePropertySubmissions backend function.
 */
 ...
 */
export function buildPropertyFromSubmission(s, { source = "approval" } = {}) {
 ...
 *
 * Unlike buildPropertyFromSubmission, this does NOT touch lifecycle fields
 * (status, onboarding_status, portal_visible) — the property keeps its state.
 */
